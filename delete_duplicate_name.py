...
Fast, memory-efficient, professional.
"""
...
PROTOCOL_FILES = {
    'vless.txt', 'reality.txt', 'vmess.txt', 'trojan.txt',
    'hysteria2.txt', 'ss.txt', 'socks.txt', 'wireguard.txt'
}
...
def main():
    ...
    for entry in os.scandir('.'):
        if entry.is_file() and entry.name in PROTOCOL_FILES:
